...
/*
 * Initializes the intEx8 library.
 * 
 * Parameters: None
 * 
 * Returns:
 *   - The initial value of `intEx8_errno`, set to `INTEX8_OK`.
 */
//int intex8_init();
 ...
 *   - `false` otherwise.
 */
inline bool ix8_is_equal(intx_t x, intx_t y) { return i8_is_equal(ix8_trim(x), ix8_trim(y)); }
 ...
 *   - `false` otherwise.
 */
inline bool ix8_is_less_eq(intx_t x, intx_t y) { return i8_is_less_eq(ix8_trim(x), ix8_trim(y)); }
 ...
 *   - `false` otherwise.
 */
inline bool ix8_is_greater_eq(intx_t x, intx_t y) { return ix8_is_less_eq(y, x); }
 ...
 *   - `false` otherwise.
 */
inline bool ix8_is_less(intx_t x, intx_t y) { return !ix8_is_less_eq(y, x); }
 ...
 *   - `false` otherwise.
 */
inline bool ix8_is_greater(intx_t x, intx_t y) { return !ix8_is_less_eq(x, y); }
 ...
 *   - `false` otherwise.
 */
inline bool ix8_is_zero(intx_t x) { return i8_is_zero(ix8_trim(x)); }
 ...
 *   - `false` otherwise.
 */
inline bool ix8_is_positive(intx_t x) { return i8_is_positive(ix8_trim(x)); }
 ...
 *   - `false` otherwise.
 */
inline bool ix8_is_negative(intx_t x) { return i8_is_negative(ix8_trim(x)); }
